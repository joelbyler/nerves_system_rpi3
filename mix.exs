defmodule NervesSystemRpi3.Mixfile do
  ...
  defp package do
   [maintainers: ["Frank Hunleth", "Justin Schneck"],
    files: ["LICENSE", "rpi3-ap-busybox.config", "mix.exs", "nerves_defconfig", "nerves.exs", "README.md", "VERSION", "rootfs-additions", "fwup.conf", "cmdline.txt", "linux-4.1.defconfig", "config.txt", "post-createfs.sh"],
    licenses: ["Apache 2.0"],
